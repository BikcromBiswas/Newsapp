...
export default function News(props) {
  ...
  useEffect( ()=>{
    console.log('in Use effect')
     ...
     {
      const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&page=${currState.page}&apiKey=`+process.env.REACT_APP_API_KEY;
      console.log(url)
  ...
  return (
    <div>
      ...
      <div className='container my-5'>
          <h2 className='text-center' >This is a news componenet</h2>
              ...
              currState.articles?.map((obj, i) => {
                return (
                  <div className='col-md-4 col-lg-4 p-5'>
                    <Newsitem key={obj.title.slice(0,5)} title={obj.title} description={obj.description} imageUrl={obj.urlToImage} newsUrl={obj.url} />
                  </div>
                );
              })
            }
