...
export default function News(props) {
  ...
  useEffect( ()=>{
    console.log('in Use effect')
     ...
     {
      const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&page=${currState.page}&pageSize=${props.pageSize}&apiKey=`+process.env.REACT_APP_API_KEY;
      console.log(url)
